...
type sCompanyListAdmin struct {
	...
	Name          string `json:"company_admin_nama"`
	Status        string `json:"company_admin_status"`
	Statuscss     string `json:"company_admin_status_css"`
	Lastlogin     string `json:"company_admin_lastlogin"`
	Lastippadress string `json:"company_admin_lastipaddres"`
	Create        string `json:"company_admin_create"`
	Update        string `json:"company_admin_update"`
}
type sCompanyListPasaran struct {
	Idcomppasaran   int    `json:"company_pasaran_idcomppasaran"`
	Idpasarantogel  string `json:"company_pasaran_idpasarantogel"`
	Nmpasarantogel  string `json:"company_pasaran_nmpasarantogel"`
	Periode         string `json:"company_pasaran_periode"`
	Winlose         int    `json:"company_pasaran_winlose"`
	Displaypasaran  int    `json:"company_pasaran_displaypasaran"`
	Status          string `json:"company_pasaran_status"`
	Statuscss       string `json:"company_pasaran_statuscss"`
	Statusactive    string `json:"company_pasaran_statuspasaranactive"`
	Statusactivecss string `json:"company_pasaran_statuspasaranactivecss"`
}
...
func Fetch_company_listpasaran(company string) (helpers.Response, error) {
	var obj sCompanyListPasaran
	var arraobj []sCompanyListPasaran
	var res helpers.Response
	msg := "Error"
	con := db.CreateCon()
	ctx := context.Background()
	...
	for row.Next() {
		...
		obj.Periode = bulanskrg
		obj.Winlose = _winlose(company, start, end, idcomppasaran_db)
		obj.Displaypasaran = displaypasaran_db
		obj.Status = statuspasaran_db
		obj.Statuscss = status_css
		obj.Statusactive = statuspasaranactive_db
		obj.Statusactivecss = status_cssactive
...
func Fetch_company_listpasaranConf(company string, idcomppasaran int) (helpers.Response, error) {
	var obj sCompanyDetailPasaranConf
	var arraobj []sCompanyDetailPasaranConf
	var res helpers.Response
	msg := "Error"
	flag := true
	con := db.CreateCon()
